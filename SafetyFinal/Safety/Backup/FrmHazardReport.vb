    ...
    Public Function CheckSameDepartment()
        Try
            If _action <> "" Then
                ...
                sqlcom.Parameters.AddWithValue("REPORT_PARENT", DungChung.Login)
                sqlcom.CommandType = CommandType.StoredProcedure
                sqlcom.CommandText = "VS_ST_HazardReport"
                Dim da As New SqlDataAdapter(sqlcom)
                Dim ds As New DataSet()
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    If IMG_PATCH1.Text <> "" Then
                        Try
                            PictureBox6.Image = Image.FromFile(DungChung.FolderShare & "\" & IMG_PATCH1.Text)
                        Catch ex As Exception

                        End Try
                    Else
                        Try
                            Dim imageData As Byte() = DirectCast(ds.Tables(0).Rows(0)("Picture"), Byte())
                            If Not imageData Is Nothing Then
                                If imageData.Length <> 0 Then
                                    Dim ms As New MemoryStream(imageData)
                                    PictureBox6.Image = Image.FromStream(ms, True)
                                End If
                            Else
                                PictureBox6.Image = Nothing
                            End If
                    ...
                    If IMG_PATCH2.Text <> "" Then
                        Try
                            PictureBox7.Image = Image.FromFile(DungChung.FolderShare & "\" & IMG_PATCH2.Text)
                        Catch ex As Exception
...
#Region "Lam moi"
    ...
    Private Sub LockGrid(ByVal TT As Boolean)
        For i As Integer = 0 To GridView1.Columns.Count - 1
            If i <> 1 And i <> 2 And i <> 3 And i <> 4 And i <> 5 And i <> 10 Then
...
#End Region
            ...
            Select Case sentmailType
                Case 0 'Gui toi nguoi duyet'
                    ...
                    body = "Dear <b>" & dearto & "</b> </br>" & _
                           ...
                           "+ Người báo cáo: <b>" & fnGetReporter(DungChung.Login) & "</b></br>" & _
                           "+ Ngày báo cáo: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b></br>" & _
                           "+ Số chứng từ: <b>" & txtDocNum.Text & "</b></br>" & _
                           "+ Nội dung/nguyên nhân: <b>" & txtDescription.Text & "</b></br>" & _
                           "Vui lòng đăng nhập vào Phần mềm Ecomaint/Safety để duyệt Báo cáo.</br>Thanks & Best regards.</br></br></br>"

                    bodyEng = "Dear <b>" & dearto & "</b> </br>" & _
                           "+ Need to review reports of: <b>" & GetHVKAT() & "</b> </br>" & _
                           "+ Reporter: <b>" & fnGetReporter(DungChung.Login) & "</b></br>" & _
                           "+ Report Date: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b></br>" & _
                           "+ Doc. No.: <b>" & txtDocNum.Text & "</b></br>" & _
                           "+ Description/ Cause: <b>" & txtDescription.Text & "</b></br>" & _
                ...
                Case 1 'Gui toi nguoi thuc hien'
                    ...
                    If dearto <> "" Then
                        dearto = GetListDearTo(dearto)
                    End If
                    Dim nduyet As String = fnGetReporter(txtApproval_User.Text)
                    body = "Dear <b>" & dearto & "</b> </br>" & _
                           "+ Báo cáo: <b>" & GetHVKAT() & "</b> </br>" & _
                           "+ Người báo cáo: <b>" & fnGetReporter(txtCreatedBy.Text) & "</b></br>" & _
                           "+ Ngày báo cáo: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b></br>" & _
                           "+ Người duyệt: <b>" & IIf(nduyet = "", txtApproval_User.Text, nduyet) & "</b></br>" & _
                           "+ Số chứng từ: <b>" & txtDocNum.Text & "</b></br>" & _
                           "+ Nội dung/nguyên nhân: <b>" & txtDescription.Text & "</b></br>" & _
                           "+ Hành động cần thực hiện: </br>"

                    bodyEng = "Dear <b>" & dearto & "</b> </br>" & _
                           "+ Report: <b>" & GetHVKAT() & "</b> </br>" & _
                           "+ Reporter: <b>" & fnGetReporter(txtCreatedBy.Text) & "</b></br>" & _
                           "+ Report Date: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b></br>" & _
                           "+ Person in charge: <b>" & IIf(nduyet = "", txtApproval_User.Text, nduyet) & "</b></br>" & _
                           "+ Doc. No.: <b>" & txtDocNum.Text & "</b></br>" & _
                           "+ Description/ Cause: <b>" & txtDescription.Text & "</b></br>" & _
                           "+ Required Actions: </br>"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "XACNHANXOACHUNGTU", Commons.Modules.TypeLanguage), Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "XACNHAN", Commons.Modules.TypeLanguage), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            End If
            body = "Dear <b>" & dearto & "</b> </br>" & _
             "<b>" & nguoixoa & "</b> đã xóa chứng từ <b>" + txtDocNum.Text + "</b></br>" & _
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChon.Click
        ...
        If op.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            PictureBox6.Image = System.Drawing.Bitmap.FromFile(op.FileName)
        End If
    End Sub
...
#End Region
    ...
    Private Sub btnChon1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChon1.Click
        ...
        If op.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            PictureBox7.Image = System.Drawing.Bitmap.FromFile(op.FileName)
        End If
    End Sub
    ...
    Private Sub PictureBox6_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox6.MouseClick
        If Not PictureBox6.Image Is Nothing Then
            Dim frm As New FrmShowImg(PictureBox6.Image, True)
            frm.Top = PictureBox6.Top + PictureBox6.Height + 72
            frm.Left = PictureBox6.Left + 388
            frm.ShowDialog()
        End If

    End Sub

    Private Sub PictureBox7_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox7.MouseClick
        If Not PictureBox7.Image Is Nothing Then
            Dim frm As New FrmShowImg(PictureBox7.Image, True)
            frm.Top = PictureBox7.Top + PictureBox7.Height + 72
            frm.Left = PictureBox7.Left + 388
            frm.ShowDialog()
        End If
    ...
    Private Sub PictureBox6_MouseEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox6.MouseClick

    End Sub
    Private Sub PictureBox7_MouseEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox7.MouseClick
