...
Public Class FrmIncidentAndAccident
    ...
    Public Sub LoadListThietBi()
        Try
            ...
            AdvBandedGridView1.Columns("THIETBI").ColumnEdit = cboStatus
            AdvBandedGridView1.Columns("THIETBI").OptionsColumn.AllowEdit = False

            AdvBandedGridView2.Columns("THIETBI").ColumnEdit = cboStatus
            AdvBandedGridView2.Columns("THIETBI").OptionsColumn.AllowEdit = False
    ...
    Public Sub LoadListNguyenNhan()
        Try
            ...
            AdvBandedGridView1.Columns("NGUYENNHAN").ColumnEdit = cboStatus
            AdvBandedGridView1.Columns("NGUYENNHAN").OptionsColumn.AllowEdit = False
            AdvBandedGridView2.Columns("NGUYENNHAN").ColumnEdit = cboStatus
            AdvBandedGridView2.Columns("NGUYENNHAN").OptionsColumn.AllowEdit = False
        Catch generatedExceptionName As Exception
    ...
    Public Sub LoadListLoaiYC()
        Try
            ...
            AdvBandedGridView1.Columns("LOAIYEUCAU").ColumnEdit = cboStatus
            AdvBandedGridView1.Columns("LOAIYEUCAU").OptionsColumn.AllowEdit = False
            AdvBandedGridView2.Columns("LOAIYEUCAU").ColumnEdit = cboStatus
            AdvBandedGridView2.Columns("LOAIYEUCAU").OptionsColumn.AllowEdit = False
        Catch generatedExceptionName As Exception
    ...
    Private Function fnValid()
        ...
        For i As Integer = 0 To AdvBandedGridView1.RowCount - 2
            ...
            End If
            If IsDBNull(AdvBandedGridView1.GetRowCellValue(i, "THIETBI")) = False Then
                If IsDBNull(AdvBandedGridView1.GetRowCellValue(i, "MUCUUTIEN")) Then
                ...
                If IsDBNull(AdvBandedGridView1.GetRowCellValue(i, "LOAIYEUCAU")) Then
                    ...
                    Return False
                End If
                If IsDBNull(AdvBandedGridView1.GetRowCellValue(i, "NGUYENNHAN")) Then
        ...
        For i As Integer = 0 To AdvBandedGridView2.RowCount - 2
            ...
            If _action = "UPDATE" Then
                ...
                End If
            End If
            If IsDBNull(AdvBandedGridView2.GetRowCellValue(i, "THIETBI")) = False Then
                If IsDBNull(AdvBandedGridView2.GetRowCellValue(i, "MUCUUTIEN")) Then
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "PHAINHAPMUCUUTIEN", Commons.Modules.TypeLanguage), Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "msgWarning", Commons.Modules.TypeLanguage), MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    'MessageBox.Show(Me, "Bạn phải nhập Preventive Action tại dòng " & (i + 1).ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    AdvBandedGridView2.ClearSelection()
                    AdvBandedGridView2.FocusedRowHandle = i
                ...
                If IsDBNull(AdvBandedGridView2.GetRowCellValue(i, "LOAIYEUCAU")) Then
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "PHAINHAPLOAIYEUCAU", Commons.Modules.TypeLanguage), Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "msgWarning", Commons.Modules.TypeLanguage), MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    'MessageBox.Show(Me, "Bạn phải nhập Preventive Action tại dòng " & (i + 1).ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    AdvBandedGridView2.ClearSelection()
                    AdvBandedGridView2.FocusedRowHandle = i
                    ...
                    Return False
                End If
                If IsDBNull(AdvBandedGridView2.GetRowCellValue(i, "NGUYENNHAN")) Then
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "PHAINHAPNGUYENNHAN", Commons.Modules.TypeLanguage), Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmHazardReport", "msgWarning", Commons.Modules.TypeLanguage), MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    'MessageBox.Show(Me, "Bạn phải nhập Preventive Action tại dòng " & (i + 1).ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    AdvBandedGridView2.ClearSelection()
                    AdvBandedGridView2.FocusedRowHandle = i
    ...
    Private Sub SimpleButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        HPES6.Checked = True
        If Commons.Modules.TypeLanguage = 0 Then
            NGUOILIENQUAN2.Text = "Ví dụ: Lê Văn Hùng"
        Else
            NGUOILIENQUAN2.Text = "Ex: Le Van Hung"
        End If
        LockGrid(False)
    ...
    Private Sub AddParameters(ByVal container As Control, ByRef sqlcom As SqlClient.SqlCommand)
        Try
            For Each c As Control In container.Controls
                ...
                If TypeOf c Is TextBox Then
                    If c.Name = "NGUOILIENQUAN2" Then
                        If NGUOILIENQUAN2.TextLength > 0 Then
                            If Commons.Modules.TypeLanguage = 0 Then
                                NGUOILIENQUAN2.Text = NGUOILIENQUAN2.Text.Replace("Ví dụ: Lê Văn Hùng", "")
                            Else
                                NGUOILIENQUAN2.Text = NGUOILIENQUAN2.Text.Replace("Ex: Le Van Hung", "")
                            End If
                        End If
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Not fnValid() Then
            Exit Sub
        End If
        Dim tenngvp As String = NGUOILIENQUAN2.Text
        If Excute(_action, CType(GridControl1.DataSource, DataTable), CType(GridControl2.DataSource, DataTable)) Then
            ...
            Select Case sentmailType
                Case 4 'Gui toi nguoi duyet HSE'
                    ...
                    body = "Dear <b>" & dearto & "</b> <br>" &
                           ...
                           "+ Người báo cáo: <b>" & fnGetReporter(IncidentReportingPerson.Text) & "</b><br>" &
                           "+ Ngày báo cáo: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b><br>" &
                           "+ Số chứng từ: <b>" & DocNum.Text & "</b><br>" &
                           "+ Mô tả sự cố: <b>" & IncidentDescription.Text & "</b><br>" &
                    ...
                    bodyEng = "Dear <b>" & dearto & "</b> <br>" &
                           ...
                           "+ Reporter: <b>" & fnGetReporter(IncidentReportingPerson.Text) & "</b><br>" &
                           "+ Report Date: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b><br>" &
                           "+ Doc. No.: <b>" & DocNum.Text & "</b><br>" &
                           "+ Incident Description: <b>" & IncidentDescription.Text & "</b><br>" &
                ...
                Case 1 'Gui toi nguoi thuc hien'
                    ...
                    body = "Dear <b>" & dearto & "</b> <br>" &
                           ...
                           "+ Người báo cáo: <b>" & fnGetReporter(IncidentReportingPerson.Text) & "</b><br>" &
                           "+ Ngày báo cáo: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b><br>" &
                           "+ Người duyệt: <b>" & IIf(nduyet = "", ApprovalBy.Text, nduyet) & "," & IIf(nduyet2 = "", ApprovalByHSE.Text, nduyet2) & "</b><br>" &
                           "+ Số chứng từ: <b>" & DocNum.Text & "</b><br>" &
                           "+ Mô tả sự cố: <b>" & IncidentDescription.Text & "</b><br>"
                    ...
                    bodyEng = "Dear <b>" & dearto & "</b> <br>" &
                           ...
                           "+ Reporter: <b>" & fnGetReporter(IncidentReportingPerson.Text) & "</b><br>" &
                           "+ Report Date: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b><br>" &
                           "+ Reviewed by: <b>" & IIf(nduyet = "", ApprovalBy.Text, nduyet) & "," & IIf(nduyet2 = "", ApprovalByHSE.Text, nduyet2) & "</b><br>" &
                           "+ Doc. No.: <b>" & DocNum.Text & "</b><br>" &
                           "+ Incident Description: <b>" & IncidentDescription.Text & "</b><br>"
                    Dim dt As DataTable = fnGetListAction()
                    If dt.Rows.Count > 0 Then
                        body = body & "+ Hành động cần thực hiện: <br>"
                        bodyEng = bodyEng & "+ Required Actions: <br>"
                ...
                Case 2 'Gui toi nguoi tao va nguoi duyet'
                    ...
                    body = "Dear <b>" & dearto & "</b> <br>" &
                           ...
                           "+ Người báo cáo: <b>" & fnGetReporter(IncidentReportingPerson.Text) & "</b><br>" &
                           "+ Ngày báo cáo: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b><br>" &
                           "+ Người thực hiện: <b>" & fnGetReporter(DungChung.Login) & "</b><br>" &
                           "+ Người duyệt: <b>" & IIf(nduyet = "", ApprovalBy.Text, nduyet) & "," & IIf(nduyet2 = "", ApprovalByHSE.Text, nduyet2) & "</b><br>" &
                           "+ Số chứng từ: <b>" & DocNum.Text & "</b><br>" &
                           "+ Mô tả sự cố: <b>" & IncidentDescription.Text & "</b><br>"
                    ...
                    bodyEng = "Dear <b>" & dearto & "</b> <br>" &
                           ...
                           "+ Reporter: <b>" & fnGetReporter(IncidentReportingPerson.Text) & "</b><br>" &
                           "+ Report Date: <b>" & Now.Date.ToString("dd/MM/yyyy") & "</b><br>" &
                           "+ Person in charge: <b>" & fnGetReporter(DungChung.Login) & "</b><br>" &
                           "+ Reviewed by: <b>" & IIf(nduyet = "", ApprovalBy.Text, nduyet) & "," & IIf(nduyet2 = "", ApprovalByHSE.Text, nduyet2) & "</b><br>" &
                           "+ Doc. No.: <b>" & DocNum.Text & "</b><br>" &
                           "+ Incident Description: <b>" & IncidentDescription.Text & "</b><br>"
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        bodyEng = bodyEng & "+ Action done:  <br>"
                        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            If tenngvp <> "" Then
                ...
                If slvp > 0 Then
                    If Commons.Modules.TypeLanguage = 0 Then
                        XtraMessageBox.Show(NGUOILIENQUAN2.Text & " đã vi phạm " & slvp.ToString() & " lần!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Else
                        XtraMessageBox.Show(NGUOILIENQUAN2.Text & " had violated " & slvp.ToString() & IIf(slvp > 1, " times!", " time!"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    End If
                End If
            End If
            ...
            _action = ""
        Else
            XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "LUUDLLOI", Commons.Modules.TypeLanguage) & vbNewLine & _ErrorMsg, Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "msgWarning", Commons.Modules.TypeLanguage), MessageBoxButtons.OK, MessageBoxIcon.Warning)
    ...
    Private Function fnGetListMailApproval()
        Try
            ...
            sqlcom.Parameters.AddWithValue("ID", txtID.Text)
            sqlcom.Parameters.AddWithValue("USER", DungChung.Login)
            sqlcom.Parameters.AddWithValue("IncidentReportingPerson", IncidentReportingPerson.Text)
            sqlcom.CommandType = CommandType.StoredProcedure
            sqlcom.CommandText = "VS_ST_IncidentAndAccident"
            Dim da As New SqlDataAdapter(sqlcom)
            Dim ds As New DataSet()
    ...
    Private Function GetHVKAT_ENG()
        ...
        If FirstAID.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "FirstAID", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "FirstAID", 1)
            End If
        End If
        If NearMiss.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "NearMiss", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "NearMiss", 1)
            End If
        End If
        If MTC.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "MTC", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "MTC", 1)
            End If
        End If
        If PropertyDamage.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "PropertyDamage", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "PropertyDamage", 1)
            End If
        End If
        If RWC.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "RWC", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "RWC", 1)
            End If
        End If
        If LTA.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "LTA", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "LTA", 1)
            End If
        End If
        If Fatality.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "Fatality", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "Fatality", 1)
            End If
        End If
        If Environment.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "Environment", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "Environment", 1)
            End If
        End If

        If WorkRelatedIllness.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "WorkRelatedIllness", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "WorkRelatedIllness", 1)
            End If
        End If
        If Fire.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "Fire", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "Fire", 1)
            End If
        End If
        If NonEmployee.Checked = True Then
            If hvkat.Length > 0 Then
                hvkat = hvkat & "," & Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "NonEmployee", 1)
            Else
                hvkat = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "FrmIncidentAndAccident", "NonEmployee", 1)
            End If
        End If
        Return hvkat
    End Function
    ...
    Private Sub AdvBandedGridView1_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles AdvBandedGridView1.MouseDown
        Try
            ...
            If hi.Column.Name = "btnThietbi" Then
                AdvBandedGridView1.CloseEditor()
                If fnCheckApprovalHSE() = False Then
                    ...
                    If frm.id <> "-1" Then
                        AdvBandedGridView1.SetFocusedRowCellValue("THIETBI", frm.id.ToString())
                    End If
            ...
            If hi.Column.Name = "btnLoaiYC" Then
                ...
                If fnCheckApprovalHSE() = False Then
                    ...
                    If frm.id <> "-1" Then
                        AdvBandedGridView1.SetFocusedRowCellValue("LOAIYEUCAU", frm.id.ToString())
                    End If
                    System.Windows.Forms.Cursor.Position = New Point(Cursor.Position.X - 140, Cursor.Position.Y + 14)
                    VirtualMouse.LeftClick()
                End If
            ...
            If hi.Column.Name = "btnNGUYENNHAN" Then
                ...
                If fnCheckApprovalHSE() = False Then
                    ...
                    If frm.id <> "-1" Then
                        AdvBandedGridView1.SetFocusedRowCellValue("NGUYENNHAN", frm.id.ToString())
                    End If
                    System.Windows.Forms.Cursor.Position = New Point(Cursor.Position.X - 140, Cursor.Position.Y + 14)
                    VirtualMouse.LeftClick()
                End If
        ...
        Try
            ...
            If hi.Column.Name = "btnThietbi1" Then
                ...
                If fnCheckApprovalHSE() = False Then
                    ...
                    If frm.id <> "-1" Then
                        AdvBandedGridView2.SetFocusedRowCellValue("THIETBI", frm.id.ToString())
                    End If
                    System.Windows.Forms.Cursor.Position = New Point(Cursor.Position.X - 140, Cursor.Position.Y + 14)
                    VirtualMouse.LeftClick()
                End If
            ...
            If hi.Column.Name = "btnLoaiYC1" Then
                ...
                If fnCheckApprovalHSE() = False Then
                    ...
                    If frm.id <> "-1" Then
                        AdvBandedGridView2.SetFocusedRowCellValue("LOAIYEUCAU", frm.id.ToString())
                    End If
                    System.Windows.Forms.Cursor.Position = New Point(Cursor.Position.X - 140, Cursor.Position.Y + 14)
                    VirtualMouse.LeftClick()
                End If
            ...
            If hi.Column.Name = "btnNGUYENNHAN1" Then
                ...
                If fnCheckApprovalHSE() = False Then
                    ...
                    If frm.id <> "-1" Then
                        AdvBandedGridView2.SetFocusedRowCellValue("NGUYENNHAN", frm.id.ToString())
                    End If
                    System.Windows.Forms.Cursor.Position = New Point(Cursor.Position.X - 140, Cursor.Position.Y + 14)
                    VirtualMouse.LeftClick()
                End If
    ...
    Public Sub GetListPersonRef()
        Try
            ...
            Dim ds As New DataSet()
            da.Fill(ds)
            NGUOILIENQUAN1.DataSource = ds.Tables(0)
            NGUOILIENQUAN1.ValueMember = "Userlogin"
            NGUOILIENQUAN1.DisplayMember = "NPT"
            NGUOILIENQUAN1.SelectedIndex = -1
        Catch generatedExceptionName As Exception
    ...
    Public Function GetListInfoNPT_BCT1()
        ...
        End Try
    End Function
    Private Sub txtNguoiLQ_TextChanged(sender As Object, e As EventArgs) Handles NGUOILIENQUAN2.TextChanged
    ...
    Private Sub btNguoiLQ_Click(sender As Object, e As EventArgs) Handles btNguoiLQ.Click
        ...
        Dim p As New Point(Me.Location.X + 272, Me.Location.Y + 488)
        frm.Location = p
        frm.Width = NGUOILIENQUAN1.Width + 10
        'frm.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedSingle
        frm.ShowDialog()
        If frm._name = "" Then
            NGUOILIENQUAN1.SelectedIndex = 0
        Else
            NGUOILIENQUAN1.Text = frm._name
        End If
    End Sub

    Private Sub NGUOILIENQUAN2_MouseClick(sender As Object, e As MouseEventArgs) Handles NGUOILIENQUAN2.MouseClick
        If NGUOILIENQUAN2.TextLength > 0 Then
            If Commons.Modules.TypeLanguage = 0 Then
                NGUOILIENQUAN2.Text = NGUOILIENQUAN2.Text.Replace("Ví dụ: Lê Văn Hùng", "")
            Else
