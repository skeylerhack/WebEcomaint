...
--exec SP_Y_GET_TSGSTTDHKT 'admin',0,'01/01/2010','12/30/2018','-1',-1,'-1','-1','-1','-1','-1'
...
SELECT DISTINCT CTTB.MS_MAY, T1.TEN_MAY, CTTB.MS_BO_PHAN + ' - ' + CTTB.TEN_BO_PHAN AS TEN_BO_PHAN , dbo.THONG_SO_GSTT.TEN_TS_GSTT, 
...
TEMP.MS_MAY,TEMP.TEN_MAY, TEMP.TEN_BO_PHAN ,TEMP.TEN_TS_GSTT,TEMP.CHU_KY_DO,TEMP.NGAY_KT_CUOI,
	   TEMP.TEN_GIA_TRI,ISNULL(TEMP.DAT,0) DAT,TEMP.NGAY_KT_KE,dbo.MGetGiaTriThongSoGSTT(TEMP.MS_TS_GSTT) AS TEN_GT_GSTT
...
SELECT  DISTINCT
          ...
          WHEN 3 THEN DATEADD(MONTH, CTTB_GSTT.CHU_KY_DO, 
          GSTT_TMP.NGAY_KT_CUOI) WHEN 4 THEN DATEADD(YEAR, CTTB_GSTT.CHU_KY_DO, 
          GSTT_TMP.NGAY_KT_CUOI) END AS NGAY_KT_KE, T1.MS_N_XUONG ,CTTB_GSTT.MS_TS_GSTT
