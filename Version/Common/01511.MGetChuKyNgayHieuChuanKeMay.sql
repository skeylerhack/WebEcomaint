IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'TF' AND name = 'MGetChuKyNgayHieuChuanKeMay')
   exec('CREATE FUNCTION  dbo.MGetChuKyNgayHieuChuanKeMay() returns  @MAY_NGAY_CUOI TABLE ([MS_MAY] [nvarchar](30) NOT NULL) as begin return end')
GO
