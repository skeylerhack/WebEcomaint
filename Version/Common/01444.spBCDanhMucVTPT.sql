...
T1.MS_PT, T1.MS_PT_CTY, T1.MS_PT_NCC, T10.TEN_CLASS, T1.TEN_PT, T1.TEN_PT_VIET, T1.QUY_CACH, T1.ANH_PT,T9.MS_LOAI_VT, 
						CASE 0 WHEN 0 THEN T9.TEN_LOAI_VT_TV WHEN 1 THEN ISNULL(NULLIF (T9.TEN_LOAI_VT_TA, ''), 
                         ...
                         T6.TEN_2, dbo.CACH_DAT_HANG.CACH_DAT_HANG, T11.SERVICE_LEVEL, T12.TEN_HSX, T13.TEN_CONG_TY, T1.HANG_NGOAI, T1.DUNG_CU_DO, T1.VAT_TU_PT, T1.ACTIVE_PT, T4.MS_LOAI_MAY, 
                         ...
                         T5.MS_LOAI_PT, T5.TEN_LOAI_PT, T1.TON_TOI_THIEU, T1.TON_KHO_MAX, T1.SO_NGAY_DAT_MUA_HANG
