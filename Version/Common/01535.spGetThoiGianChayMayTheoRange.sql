...
GO
--spGetThoiGianChayMayTheoRange 'HTD-02-19', '06/01/2019', '06/05/2019', N'10|5|6', 'HTD-02-19'
--spGetThoiGianChayMayTheoRange 'AIC-1504', '07/17/2016', '07/18/2017', N'-1', '-1'
ALTER PROCEDURE [dbo].[spGetThoiGianChayMayTheoRange]
	@MS_MAY NVARCHAR(50),
	@TNGAY DATETIME,
	@DNGAY DATETIME, 
	@VALUE NVARCHAR(20) = '-1',
...
BEGIN
	...
	BEGIN
		...
		CASE ISNULL(T1.CHI_SO_DONG_HO,0) WHEN 0 THEN	
                CASE DATEPART(DW, DATEADD(DAY, number, @TNGAY))
                  WHEN 7
                  THEN ( SELECT Item
                         FROM   UDF_ConvertListItem2Table(@VALUE, N'|')
                         WHERE  Id = 2
                       )
                  WHEN 1
                  THEN ( SELECT Item
                ...
                END ELSE T1.CHI_SO_DONG_HO END AS CHI_SO_DONG_HO, ISNULL(T1.SO_GIO_LUY_KE,0) SO_GIO_LUY_KE, T1.SO_MOVEMENT
