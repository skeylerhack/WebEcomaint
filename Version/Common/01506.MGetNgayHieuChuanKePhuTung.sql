...
GO
--41
--	SELECT * FROM [dbo].[MGetNgayHieuChuanKePhuTung]('01/01/202  0','12/31/2020',13,'Administrator','-1',-1,'-1','-1',0)  A ORDER BY MS_MAY, MS_PT, MS_VI_TRI, MS_DV_TG,CHU_KY,NGAY_KE
...
(
	...
	FROM 
		(
			SELECT     T2.MS_MAY,T2.MS_PT +' '+T4.TEN_PT AS MS_PT, T2.MS_VI_TRI, T1.NGAY_HC_CUOI , 
