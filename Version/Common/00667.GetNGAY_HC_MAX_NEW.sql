...
IF @HC_DHD = 1
BEGIN
	SELECT MAX(T.NGAY_KH) AS NGAY_HC_CUOI, CASE @LOAI_HC WHEN 0 THEN T1.CHU_KY_HC_NOI WHEN 1 THEN T1.CHU_KY_HC_NGOAI WHEN 2 THEN T1.CHU_KY_KD ELSE T1.CHU_KY_KT END AS CHU_KY, T1.MS_DV_TG AS DON_VI FROM HIEU_CHUAN_DHD T
