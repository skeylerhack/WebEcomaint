...
/****** Object:  Table [dbo].[SYN_TB_XUAT_KHO_INTEGRATION]    Script Date: 08/12/2015 11:14:43 ******/
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SYN_TB_XUAT_KHO_INTEGRATION]') AND type in (N'U'))
BEGIN
...
IF  NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_SYN_TB_PHIEU_XUAT_DA_CHUYEN]') AND type = 'D')
BEGIN
