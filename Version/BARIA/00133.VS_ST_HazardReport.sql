IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'VS_ST_HazardReport')
   exec('CREATE PROCEDURE VS_ST_HazardReport AS BEGIN SET NOCOUNT ON; END')
GO
...
BEGIN
	...
	--GET REPORT TYPE
		IF OBJECT_ID(N'ReportType', N'U') IS NOT NULL
			DROP TABLE ReportType
		SELECT * INTO ReportType FROM (
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'cbUnsafeCondition') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE UnsafeCondition = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'cbUnsafeBehavior') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE  UnsafeBehevior = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'cbSafetySuggestion') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE SatetySuggestion = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'cbNearMiss') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE ID = 10 AND NearMiss = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'cbMT') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE Environment = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbTT') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE TT = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'cbOther') AS ReportTypeName, ID FROM dbo.ST_HazardReport WHERE Other = 1) AS RT

			--GET ROOM
			IF OBJECT_ID(N'Room', N'U') IS NOT NULL
				DROP TABLE Room
			SELECT * INTO Room FROM (
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'Operation') AS RoomName, ID FROM dbo.ST_HazardReport WHERE Operation = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'Tally') AS RoomName, ID FROM dbo.ST_HazardReport WHERE  Tally = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'TechHSE') AS RoomName, ID FROM dbo.ST_HazardReport WHERE  TechHSE = 1
				UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'Procu') AS RoomName, ID FROM dbo.ST_HazardReport WHERE  Procu = 1
				UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'HR') AS RoomName, ID FROM dbo.ST_HazardReport WHERE  HR = 1
				UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'Account') AS RoomName, ID FROM dbo.ST_HazardReport WHERE  Acount = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'Commercial') AS RoomName, ID FROM dbo.ST_HazardReport WHERE  Commercial = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'ChooseHazardReport' AND KEYWORD = 'External') AS RoomName, ID FROM dbo.ST_HazardReport WHERE [External] = 1
			) AS R

			--BELONG TO
			IF OBJECT_ID(N'Belong', N'U') IS NOT NULL
				DROP TABLE Belong
			SELECT * INTO Belong FROM (
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbBelongtoContractor') AS Belong, ID FROM dbo.ST_HazardReport WHERE BelongContractor = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbBelongtoBSPort') AS Belong, ID FROM dbo.ST_HazardReport WHERE  BelongToBSPort = 1) AS BT

			--Stopwork
			IF OBJECT_ID(N'Stopwork', N'U') IS NOT NULL
				DROP TABLE Stopwork
			SELECT * INTO Stopwork FROM (
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'rdYes') AS Stopwork, ID FROM dbo.ST_HazardReport WHERE Stopwork = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE @NNgu WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'rdNo') AS Stopwork, ID FROM dbo.ST_HazardReport WHERE  Stopwork = 0) AS S

			-- HPE
			IF OBJECT_ID(N'HPE', N'U') IS NOT NULL
				DROP TABLE HPE
			SELECT * INTO HPE FROM (
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE 0 WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbHPES1') AS HPE, ID FROM dbo.ST_HazardReport WHERE HPES1 = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE 0 WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbHPES2') AS HPE, ID FROM dbo.ST_HazardReport WHERE  HPES2 = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE 0 WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbHPES3') AS HPE, ID FROM dbo.ST_HazardReport WHERE  HPES3 = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE 0 WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbHPES4') AS HPE, ID FROM dbo.ST_HazardReport WHERE  HPES4 = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE 0 WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbHPES5') AS HPE, ID FROM dbo.ST_HazardReport WHERE  HPES5 = 1
			UNION
			SELECT (SELECT TOP 1 CONVERT(NVARCHAR(50), CASE 0 WHEN 0 THEN VIETNAM WHEN 1 THEN ISNULL(NULLIF (ENGLISH, ''), VIETNAM) ELSE ISNULL(NULLIF (CHINESE, ''), VIETNAM) END) FROM LANGUAGES WHERE FORM = 'FrmHazardReport' AND KEYWORD = 'cbHPES6') AS HPE, ID FROM dbo.ST_HazardReport WHERE  HPES6 = 1
			) AS HPE
		...
		DISTINCT
			...
			,CASE WHEN ISNULL(T1.NGUOILIENQUAN2,'') <> '' THEN  ISNULL(T5.Staffname,'-')+','+ISNULL(T1.NGUOILIENQUAN2,'-') ELSE  ISNULL(T5.Staffname,'-') END NLQVP, T6.LocationName, (SELECT TOP 1 ReportTypeName FROM ReportType WHERE ID = T1.ID) AS ReportTypeName, (SELECT TOP 1 RoomName FROM Room WHERE ID = T1.ID) AS RoomName, (SELECT TOP 1 Belong FROM Belong WHERE ID = T1.ID) AS Belong, (SELECT TOP 1 Stopwork FROM Stopwork WHERE ID = T1.ID) AS Stopwork, (SELECT TOP 1 HPE FROM HPE WHERE ID = T1.ID) AS HPE
		...
		LEFT JOIN [dbo].[ST_Locations] T6 ON T1.[Location] = T6.ID 
	...
	IF @ACTION='LIST_LOAIMOINGUY'
	BEGIN
		SELECT [ID],Hazard FROM [dbo].ST_Hazards
	END
