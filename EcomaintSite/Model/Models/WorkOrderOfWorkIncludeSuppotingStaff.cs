namespace Model.Data
{
    ...
    [Table("PHIEU_BAO_TRI_CONG_VIEC_NHAN_SU_PHU_TRO")]
    public partial class WorkOrderOfWorkIncludeSuppotingStaff
    {
        [Key]
        ...
        public int WorkOrderOfSupportingWorkID { get; set; }

        [Key]
        [Column("MS_CONG_NHAN", Order = 2)]
        [StringLength(9)]
