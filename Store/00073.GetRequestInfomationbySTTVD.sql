...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'GetRequestInfomationbySTTVD')
   
exec('CREATE PROCEDURE GetRequestInfomationbySTTVD AS BEGIN SET NOCOUNT ON; END')

GO

ALTER PROCEDURE GetRequestInfomationbySTTVD
